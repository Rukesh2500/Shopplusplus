              ...
              <div class="branch-info-item">
                ...
                <div class="branch-info-body box--shadow">
                  <ul class="text-center">
                    <li>Address: 168/170, Brodipet, Guntur, Andhra Pradesh</li>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="branch-info-item">
                ...
                <div class="branch-info-body box--shadow">
                  <ul class="text-center">
                    <li>
                      Address: 25-22-105, Ajith Singh Nagar, Vijayawada, Andhra Pradesh
                    </li>
                    <li>Email: info.example@gmail.com</li>
                    <li>Phone: +91 000 0000000</li>
                    <li>Web: www.yourwebsite.com</li>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="branch-info-item">
                ...
                <div class="branch-info-body box--shadow">
                  <ul class="text-center">
                    <li>
                      Address: 150/58, Rtc Colony, Vizag, Andhra Pradesh
                    </li>
                    <li>Email: info.example@gmail.com</li>
                    <li>Phone: +91 000 0000000</li>
                    <li>Web: www.yourwebsite.com</li>
